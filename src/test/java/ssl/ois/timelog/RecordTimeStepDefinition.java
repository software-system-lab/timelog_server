...
public class RecordTimeStepDefinition {
  ...
  public void i_record_the_activity_to_Timelog() throws Exception {
    this.result = this.mvc.perform(MockMvcRequestBuilders.post("/log/record").content(asJsonString(this.body))
  ...
  public void i_can_get_the_complete_log_with_this_log_ID() {
      // Write code here that turns the phrase above into concrete actions
      throw new io.cucumber.java.PendingException();
  }

  @Then("This log has title {string}")
  public void this_log_has_title(String string) {
      // Write code here that turns the phrase above into concrete actions
      throw new io.cucumber.java.PendingException();
  }

  @Then("This log has start time with {string}")
  public void this_log_has_start_time_with(String string) {
      // Write code here that turns the phrase above into concrete actions
      throw new io.cucumber.java.PendingException();
  }

  @Then("This log has end time with {string}")
  public void this_log_has_end_time_with(String string) {
      // Write code here that turns the phrase above into concrete actions
      throw new io.cucumber.java.PendingException();
  }

  @Then("This log has detail {string}")
  public void this_log_has_detail(String string) {
      // Write code here that turns the phrase above into concrete actions
      throw new io.cucumber.java.PendingException();
  }

  @Then("This log has activity type {string}")
  public void this_log_has_activity_type(String string) {
      // Write code here that turns the phrase above into concrete actions
      throw new io.cucumber.java.PendingException();
  }
